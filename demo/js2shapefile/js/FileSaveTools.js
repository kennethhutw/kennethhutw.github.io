...
(function(preferredOptions){
    ...
    var sourceUrls = {
        ...
        saveAs: "lib/external/FileSaver.min.js",
        JSZip: "lib/external/jszip.js",
        // currently BlobBuilder script is included in this file so no need to load
        BlobBuilder: "lib/external/BlobBuilder_mod.js",
        jDataView_write: "lib/jDataView_write.js",
        Downloadify: "lib/downloadify/js/downloadify.js",
        swfobject: "lib/downloadify/js/swfobject.js"
    };
